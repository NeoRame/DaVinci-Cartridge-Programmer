...
char m[] = {0x41};
char selcolor[15] = "Schwarz"; //Max Letters 15
char cr[] = {0x4B,0x00};
...
switch (intColor) {
  ...
  tft.setTextColor(PURPLE);
      strcpy(selcolor,"Lila"); //Purple (Purpure)
      cr[0] = 0x41;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(VIOLET);
      strcpy(selcolor,"Violett"); //Violet
      cr[0] = 0x4C;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(PURPURIN);
      strcpy(selcolor,"Purpur"); //Purpurin
      cr[0] = 0x4E;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(TANGERINE);
      strcpy(selcolor,"Orangerot"); //Tangerine
      cr[0] = 0x54;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(CYBERYELLOW);
      strcpy(selcolor,"Cyber Gelb"); //Cyber Yellow
      cr[0] = 0x53;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(NEONGREEN);
      strcpy(selcolor,"NEON Gruen"); //NEON Green
      cr[0] = 0x48;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(NEONYELLOW);
      strcpy(selcolor,"NEON Gelb"); //NEON Yellow
      cr[0] = 0x4A;
      cr[1] = 0x00;
      changecolor();
    break;
  case 19:
  tft.setTextColor(GREY);
      strcpy(selcolor,"Schneeweiss"); //Snow White
      cr[0] = 0x49;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(GRAPEPURPLE);
      strcpy(selcolor,"Weintraube"); //Grape Purple
      cr[0] = 0x4D;
      cr[1] = 0x00;
      changecolor();
    break;
  case 21:
  tft.setTextColor(YELLOW);
      strcpy(selcolor,"Gelb Klar"); //Clear Yellow
      cr[0] = 0x4F;
      cr[1] = 0x00;
      changecolor();
    break;
  case 22:
  tft.setTextColor(GREEN);
      strcpy(selcolor,"Gruen Klar"); //Clear Green
      cr[0] = 0x50;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(ORANGE);
      strcpy(selcolor,"Orangerot Klar"); //Clear Tangerine
      cr[0] = 0x51;
      cr[1] = 0x00;
      changecolor();
    break;
  case 24:
  tft.setTextColor(BLUE);
      strcpy(selcolor,"Blau Klar"); //Clear Blue
      cr[0] = 0x55;
      cr[1] = 0x00;
      changecolor();
    break;
  case 25:
  tft.setTextColor(PURPLE);
      strcpy(selcolor,"Lila Klar"); //Clear Purple
      cr[0] = 0x56;
      cr[1] = 0x00;
      changecolor();
    break;
  ...
  tft.setTextColor(MAGENTA);
      strcpy(selcolor,"Magenta Klar"); //Clear Magenta
      cr[0] = 0x58;
      cr[1] = 0x00;
      changecolor();
    break;
...
void drawMenu () {
  ...
  tft.setTextColor(WHITE);
  tft.setCursor (35, 5);
  tft.println("Filament Konfigurator");
  tft.setTextSize (2);
  tft.setTextColor(WHITE);
...
void drawButtons () {
  tft.fillRect(250, 240, 80, 20, RED); // SICHERN
}
...
{
  do {
    Serial.println("Teste Verbindung zum DaVinci EEPROM CHIP\n");    
    delay(100);
  } 
  while(!unio.read_status(&sr));

  Serial.println("DaVinci EEPROM gefunden...");
  Serial.println("Lese die DaVinci EEPROM Inhalte...");
  dump_eeprom(0,128);
}
...
void factory_setting()
{
  ...
  Serial.println("Aktualisiere EEPROM...");
...
{
  do {
    Serial.println("Teste Verbindung zu DaVinci EEPROM CHIP\n");    
    delay(100);
  } 
  while(!unio.read_status(&sr));
